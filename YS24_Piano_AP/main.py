...
def main(args):
    ...
    key_3 = Key(Button(20), Dn4, keyCmap)
    key_5 = Key(Button(16), En4, keyAmap)
    key_6 = Key(Button(12), Fn4, keyAmap)
    key_8 = Key(Button(1), Gn4, keyAmap)
    key_10 = Key(Button(25), An4, keyAmap)
    key_12 = Key(Button(26), Bn4, keyAmap)
    
    key_2 = Key(Button(19), Cs4, keyCmap)
    key_4 = Key(Button(13), Ds4, keyAmap)
    key_7 = Key(Button(6), Fs4, keyAmap)
    key_9 = Key(Button(5), Gs4, keyAmap)
    key_11 = Key(Button(0), As4, keyAmap)

    key_13 = Key(Button(11), Cn5, keyAmap)
    key_15 = Key(Button(9), Dn5, keyAmap)
    key_17 = Key(Button(10), En5, keyAmap)
    key_18 = Key(Button(22), Fn5, keyAmap)
    key_20 = Key(Button(17), Gn5, keyAmap)
    key_22 = Key(Button(4), An5, keyAmap)
    key_24 = Key(Button(3), Bn5, keyAmap)

    key_14 = Key(Button(24), Cs5, keyAmap)
    key_16 = Key(Button(23), Ds5, keyAmap)
    key_19 = Key(Button(15), Fs5, keyAmap)
    key_21 = Key(Button(14), Gs5, keyAmap)
    key_23 = Key(Button(2), As5, keyAmap)
