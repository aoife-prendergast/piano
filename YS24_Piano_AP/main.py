...
def main(args):
    ...
    key_1 = Key(Button(4, bounce_time = 0.1), Cn4, key1map)
    key_3 = Key(Button(3, bounce_time = 0.1), Dn4, key3map)
    key_5 = Key(Button(2, bounce_time = 0.1), En4, key5map)
    key_6 = Key(Button(14, bounce_time = 0.1), Fn4, key6map)
    key_8 = Key(Button(15, bounce_time = 0.1), Gn4, key8map)
    key_10 = Key(Button(23, bounce_time = 0.1), An4, key10map)
    key_12 = Key(Button(24, bounce_time = 0.1), Bn4, key12map)
    
    key_2 = Key(Button(17, bounce_time = 0.1), Cs4, key2map)
    key_4 = Key(Button(22, bounce_time = 0.1), Ds4, key4map)
    key_7 = Key(Button(10, bounce_time = 0.1), Fs4, key7map)
    key_9 = Key(Button(9, bounce_time = 0.1), Gs4, key9map)
    key_11 = Key(Button(11, bounce_time = 0.1), As4, key11map)

    key_13 = Key(Button(21, bounce_time = 0.1), Cn5, key13map)
    key_15 = Key(Button(20, bounce_time = 0.1), Dn5, key15map)
    key_17 = Key(Button(16, bounce_time = 0.1), En5, key17map)
    key_18 = Key(Button(12, bounce_time = 0.1), Fn5, key18map)
    key_20 = Key(Button(1, bounce_time = 0.1), Gn5, key20map)
    key_22 = Key(Button(25, bounce_time = 0.1), An5, key22map)
    key_24 = Key(Button(26, bounce_time = 0.1), Bn5, key24map)

    key_14 = Key(Button(0, bounce_time = 0.1), Cs5, key14map)
    key_16 = Key(Button(5, bounce_time = 0.1), Ds5, key16map)
    key_19 = Key(Button(6, bounce_time = 0.1), Fs5, key19map)
    key_21 = Key(Button(13, bounce_time = 0.1), Gs5, key21map)
    key_23 = Key(Button(19, bounce_time = 0.1), As5, key23map)
