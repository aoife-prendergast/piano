...
def main(args):
    ...
    key_1 = Key(Button(4), Cn4, key1map)
    key_3 = Key(Button(3), Dn4, key3map)
    key_5 = Key(Button(2), En4, key5map)
    key_6 = Key(Button(14), Fn4, key6map)
    key_8 = Key(Button(15), Gn4, key8map)
    key_10 = Key(Button(23), An4, key10map)
    key_12 = Key(Button(24), Bn4, key12map)
    
    key_2 = Key(Button(17), Cs4, key2map)
    key_4 = Key(Button(22), Ds4, key4map)
    key_7 = Key(Button(10), Fs4, key7map)
    key_9 = Key(Button(9), Gs4, key9map)
    key_11 = Key(Button(11), As4, key11map)

    key_13 = Key(Button(21), Cn5, key13map)
    key_15 = Key(Button(20), Dn5, key15map)
    key_17 = Key(Button(16), En5, key17map)
    key_18 = Key(Button(12), Fn5, key18map)
    key_20 = Key(Button(1), Gn5, key20map)
    key_22 = Key(Button(25), An5, key22map)
    key_24 = Key(Button(26), Bn5, key24map)

    key_14 = Key(Button(0), Cs5, key14map)
    key_16 = Key(Button(5), Ds5, key16map)
    key_19 = Key(Button(6), Fs5, key19map)
    key_21 = Key(Button(13), Gs5, key21map)
    key_23 = Key(Button(19), As5, key23map)
